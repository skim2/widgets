			...
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-50">
				<form class="login100-form validate-form" action="<?php echo htmlspecialchars( "oa_sso_connect.php" ); ?>" method="post">
					<span class="login100-form-title p-b-33">
						<!--
						<img src="./images/krit_logo_header.png" width="58%" alt="EBSCO APAC">
						-->
						<h6>국방기술진흥연구소 전자도서관</h6>
						<img src="./images/krit_lib_logo.png" alt="OpenAthens Login" width="58%">
						<h6>Log in with your OA account</h6>
					</span>
					...
					<div class="text-center">
						<a href="https://lib.krit.re.kr:8443/login" class="txt2 hov1" target="_blank">
							<span class="txt1">국방기술진흥연구소(KRIT) 전자도서관</span>
						</a>
					</div>
