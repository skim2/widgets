...
if($_SESSION['oa_login']){
   header("location:https://go.openathens.net/redirector/neca.re.kr?url=https%3A%2F%2Fneca.egentouch.com%2Fmain.do%3Faction%3Dmain");
   die;
}
...
{
    $api_key = "KE7tBUfQB99A5uNPu3YMoS5cOrUH2rvOxYKy4sHe";
    ...
    else
    {
        ...
        $remote_url = 'https://login.openathens.net/api/v1/neca.re.kr/organisation/72320746/local-auth/session?username='.$username.'&returnUrl=https%3A%2F%2Flogin.openathens.net%2Fauth%2Fneca.re.kr%2Fo%2F72320746';
		https://login.openathens.net/api/v1/neca.re.kr/organisation/72320746/local-auth/session?username=cHNtQG5lY2EucmUua3I6TkVDQWxpYjIxNzQh&returnUrl=https%3A%2F%2Flogin.openathens.net%2Fauth%2Fneca.re.kr%2Fo%2F72320746
        $headers = array(
            'Content-Type:application/json',
