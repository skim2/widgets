...
{
    $api_key = "12264fb5-a97a-4c0d-a965-5b724d33026f";
    $remote_url = 'https://login.openathens.net/api/v1/kopri.re.kr/organisation/80011145/local-auth/session';
...
<body>
    <center>
        <h1>극지연구소</br>Korea Polar Research Institute</h1>
        <hr></hr>
