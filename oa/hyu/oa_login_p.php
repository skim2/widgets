	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-50">
				...
				<form class="login100-form validate-form" action="<?php echo htmlspecialchars( "oa_sso_connect_p.php" ); ?>" method="post">
					...
					<div>
						...
						<span class="m-l-5">
							<select id="user_inst_cd" name="user_inst_cd">
								...
								<option value="3" selected>백남학술정보관</option>
								...
								<option value="9">ERICA학술정보관</option>
					...
					<div>
						...
						<span class="m-l-5">
							<select id="user_department_cd" name="user_department_cd">
								...
								<option value="H0000343" selected>서울 대학원</option>
								...
								<option value="Y0000316">ERICA 대학</option>
