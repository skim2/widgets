<?php
	...
	// 1. By Pass redirect 할 TarREQUEST
		...
		// 2-18. KluwerLaw Online 처리		
		} else if (strpos($_REQUEST['url'], "kluwerlawonline.com") == true) {
		header("Location: "."https://proxy.openathens.net/login?entityID=https%3A%2F%2Fidp.hanyang.ac.kr%2Fentity&qurl=https%3A%2F%2Fwww.kluwerlawonline.com%2F");
		// 2-19. Optica 처리		
		} else if (strpos($_REQUEST['url'], "opg.optica.org") == true) {
		header("Location: "."https://proxy.openathens.net/login?entityID=https%3A%2F%2Fidp.hanyang.ac.kr%2Fentity&qurl=https%3A%2F%2Fopg.optica.org%2F");	
		// 2-20. OSIRIS, ORBIS M&A 처리		
